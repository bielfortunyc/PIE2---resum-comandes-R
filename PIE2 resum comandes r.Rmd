...
Funció anova(model1, model2)
Ens fa una comparació amb test d'hipòtesi: H0: model1=model2, H1:model1!=model2.
Normalment el model2 està aniuat al model1, de manera que aquest té més paràmetres. El que volem veure és si el model2 és significativament diferent del model 1, podem mirar AIC i fer el test anova. Ens dona un p-valor sobre l'anterior test d'hipòtesi. Si surt significatiu vol dir que val la pena quedar-se amb el model2.
