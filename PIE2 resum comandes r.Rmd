...
```{r}
Important passar a factor les variables categòriques!
...
Funció anova.
Es fa anova(model1, model2) per comparar dos models. Model2 està aniuat a Model1 i volem saber si són diferents. H0: ens quedem amb model1, H1: és millor el model2. 
Fent anova(model1, model2) s'executa aquest test d'hipòtesis i ens en dona el p-valor: si és significatiu ens quedem amb el model2.
